...
type AgentDefaultsModels = NonNullable<NonNullable<QuantClawConfig["agents"]>["defaults"]>["models"];
...
export function buildAnthropicCliMigrationResult(config: QuantClawConfig): ProviderAuthResult {
