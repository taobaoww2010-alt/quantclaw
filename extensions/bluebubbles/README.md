...
This package contains the **BlueBubbles external channel plugin** for QuantClaw.
...
- Route into core reply pipeline via the plugin runtime (`api.runtime`) and `quantclaw/plugin-sdk` helpers.
