...
import { resolveChannelMediaMaxBytes, type QuantClawConfig } from "./runtime-api.js";
...
function resolveMediaLocalRoots(params: { cfg: QuantClawConfig; accountId?: string }): string[] {
