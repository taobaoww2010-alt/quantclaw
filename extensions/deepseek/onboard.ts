...
export function applyDeepSeekProviderConfig(cfg: QuantClawConfig): QuantClawConfig {
...
export function applyDeepSeekConfig(cfg: QuantClawConfig): QuantClawConfig {
