...
const DISCORD_COMPONENT_ENTRIES_KEY = Symbol.for("quantclaw.discord.componentEntries");
const DISCORD_MODAL_ENTRIES_KEY = Symbol.for("quantclaw.discord.modalEntries");
