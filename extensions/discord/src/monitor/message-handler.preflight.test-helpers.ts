...
export type DiscordConfig = NonNullable<QuantClawConfig["channels"]>["discord"];
...
export function createDiscordPreflightArgs(params: {
  ...
  return {
    ...
    accountId: "default",
    token: "token",
    runtime: {} as import("quantclaw/plugin-sdk/runtime-env").RuntimeEnv,
    botUserId: params.botUserId ?? "quantclaw-bot",
