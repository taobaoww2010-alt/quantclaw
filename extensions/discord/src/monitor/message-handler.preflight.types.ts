...
import type { ReplyToMode } from "quantclaw/plugin-sdk/config-runtime";
...
import type { resolveAgentRoute } from "quantclaw/plugin-sdk/routing";
...
export type LoadedConfig = ReturnType<
  typeof import("quantclaw/plugin-sdk/config-runtime").loadConfig
>;
export type RuntimeEnv = import("quantclaw/plugin-sdk/runtime-env").RuntimeEnv;
...
type DiscordMessagePreflightSharedFields = {
  ...
  discordConfig: NonNullable<
    import("quantclaw/plugin-sdk/config-runtime").QuantClawConfig["channels"]
  >["discord"];
  accountId: string;
  token: string;
  runtime: RuntimeEnv;
