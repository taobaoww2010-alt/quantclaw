...
function buildNoImageGenerationModelConfiguredMessage(cfg: QuantClawConfig): string {
...
export function listRuntimeImageGenerationProviders(params?: { config?: QuantClawConfig }) {
