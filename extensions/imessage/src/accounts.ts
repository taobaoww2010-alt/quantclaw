...
function mergeIMessageAccountConfig(cfg: QuantClawConfig, accountId: string): IMessageAccountConfig {
...
export function listEnabledIMessageAccounts(cfg: QuantClawConfig): ResolvedIMessageAccount[] {
