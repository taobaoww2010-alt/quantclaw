...
export function applyKilocodeProviderConfig(cfg: QuantClawConfig): QuantClawConfig {
  return kilocodePresetAppliers.applyProviderConfig(cfg);
}

export function applyKilocodeConfig(cfg: QuantClawConfig): QuantClawConfig {
