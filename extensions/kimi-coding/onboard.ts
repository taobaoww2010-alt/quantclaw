...
export function applyKimiCodeProviderConfig(cfg: QuantClawConfig): QuantClawConfig {
  return kimiCodingPresetAppliers.applyProviderConfig(cfg);
}

export function applyKimiCodeConfig(cfg: QuantClawConfig): QuantClawConfig {
