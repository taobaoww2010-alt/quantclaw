...
export function listMattermostAccountIds(cfg: QuantClawConfig): string[] {
  return mattermostAccountHelpers.listAccountIds(cfg);
}

export function resolveDefaultMattermostAccountId(cfg: QuantClawConfig): string {
...
export function listEnabledMattermostAccounts(cfg: QuantClawConfig): ResolvedMattermostAccount[] {
