...
import { createTopLevelChannelConfigAdapter } from "quantclaw/plugin-sdk/channel-config-helpers";
import type {
...
import type { ChannelMessageActionName, ChannelPlugin, QuantClawConfig } from "../runtime-api.js";
import {
...
const resolveMSTeamsChannelConfig = (cfg: QuantClawConfig) => ({
...
export const msteamsPlugin: ChannelPlugin<ResolvedMSTeamsAccount, ProbeMSTeamsResult> =
  createChatChannelPlugin({
    ...
    security: {
      collectWarnings: projectConfigWarningCollector<{ cfg: QuantClawConfig }>(
