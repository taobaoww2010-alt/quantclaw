...
Nostr DM channel plugin for QuantClaw using NIP-04 encrypted direct messages.

## Overview

This extension adds Nostr as a messaging channel to QuantClaw. It enables your bot to:
...
```bash
quantclaw plugins install @quantclaw/nostr
```
...
# Configure quantclaw to use local relay
