...
function resolveConfiguredDefaultNostrAccountId(cfg: QuantClawConfig): string | undefined {
 ...
 */
export function listNostrAccountIds(cfg: QuantClawConfig): string[] {
  const nostrCfg = (cfg.channels as Record<string, unknown> | undefined)?.nostr as
    | NostrAccountConfig
    | undefined;
 ...
 */
export function resolveDefaultNostrAccountId(cfg: QuantClawConfig): string {
