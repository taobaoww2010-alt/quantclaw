...
function sortSpeechProvidersForAutoSelection(cfg?: QuantClawConfig) {
...
function resolveRegistryDefaultSpeechProviderId(cfg?: QuantClawConfig): TtsProvider {
...
export function resolveTtsConfig(cfg: QuantClawConfig): ResolvedTtsConfig {
...
function resolveEffectiveTtsAutoState(params: { cfg: QuantClawConfig; sessionAuto?: string }): {
...
export function buildTtsSystemPromptHint(cfg: QuantClawConfig): string | undefined {
...
export function resolveTtsProviderOrder(primary: TtsProvider, cfg?: QuantClawConfig): TtsProvider[] {
...
export async function textToSpeech(params: {
  ...
  const tempRoot = resolvePreferredQuantClawTmpDir();
