...
vi.mock("quantclaw/plugin-sdk/setup", async () => {
  const actual = await vi.importActual<object>("quantclaw/plugin-sdk/setup");
  return {
    ...actual,
...
vi.mock("quantclaw/plugin-sdk/channel-config-schema", async () => {
  const actual = await vi.importActual<object>("quantclaw/plugin-sdk/channel-config-schema");
  return {
    ...actual,
...
vi.mock("quantclaw/plugin-sdk/webhook-ingress", async () => {
  const actual = await vi.importActual<object>("quantclaw/plugin-sdk/webhook-ingress");
  return {
    ...actual,
