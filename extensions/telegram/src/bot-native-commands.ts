...
export const registerTelegramNativeCommands = ({
  ...
  const loadFreshRuntimeConfig = (): QuantClawConfig => telegramDeps.loadConfig();
  const resolveFreshTelegramConfig = (runtimeCfg: QuantClawConfig): TelegramAccountConfig => {
    try {
