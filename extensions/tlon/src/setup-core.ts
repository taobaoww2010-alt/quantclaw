...
export async function resolveTlonSetupConfigured(cfg: QuantClawConfig): Promise<boolean> {
...
export async function resolveTlonSetupStatusLines(cfg: QuantClawConfig): Promise<string[]> {
