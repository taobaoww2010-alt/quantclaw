...
import { resolveOAuthDir } from "quantclaw/plugin-sdk/state-paths";
...
export function listWhatsAppAuthDirs(cfg: QuantClawConfig): string[] {
...
export function hasAnyWhatsAppAuth(cfg: QuantClawConfig): boolean {
...
export function resolveWhatsAppAuthDir(params: { cfg: QuantClawConfig; accountId: string }): {
  authDir: string;
  isLegacy: boolean;
} {
...
export function listEnabledWhatsAppAccounts(cfg: QuantClawConfig): ResolvedWhatsAppAccount[] {
