...
vi.mock("quantclaw/plugin-sdk/security-runtime", async (importOriginal) => {
  const actual = await importOriginal<typeof import("quantclaw/plugin-sdk/security-runtime")>();
  return {
    ...actual,
