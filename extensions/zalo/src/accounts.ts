...
function mergeZaloAccountConfig(cfg: QuantClawConfig, accountId: string): ZaloAccountConfig {
...
export function listEnabledZaloAccounts(cfg: QuantClawConfig): ResolvedZaloAccount[] {
