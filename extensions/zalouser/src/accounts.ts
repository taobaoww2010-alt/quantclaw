...
function mergeZalouserAccountConfig(cfg: QuantClawConfig, accountId: string): ZalouserAccountConfig {
...
function resolveZalouserAccountBase(params: { cfg: QuantClawConfig; accountId?: string | null }) {
