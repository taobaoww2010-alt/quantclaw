...
const targetModel =
  modelIds.find((id) => id === "quantclaw/default") ?? modelIds.find((id) => id === "quantclaw");
if (!targetModel) {
  throw new Error(`quantclaw model missing from Open WebUI model list: ${JSON.stringify(modelIds)}`);
}
