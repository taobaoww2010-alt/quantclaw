...
export function isAcpEnabledByPolicy(cfg: QuantClawConfig): boolean {
  return cfg.acp?.enabled !== false;
}

export function resolveAcpDispatchPolicyState(cfg: QuantClawConfig): AcpDispatchPolicyState {
...
export function isAcpDispatchEnabledByPolicy(cfg: QuantClawConfig): boolean {
  return resolveAcpDispatchPolicyState(cfg) === "enabled";
}

export function resolveAcpDispatchPolicyMessage(cfg: QuantClawConfig): string | null {
...
export function resolveAcpDispatchPolicyError(cfg: QuantClawConfig): AcpRuntimeError | null {
...
export function isAcpAgentAllowedByPolicy(cfg: QuantClawConfig, agentId: string): boolean {
