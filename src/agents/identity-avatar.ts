...
function resolveAvatarSource(cfg: QuantClawConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: QuantClawConfig, agentId: string): AgentAvatarResolution {
