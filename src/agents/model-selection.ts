...
export function isCliProvider(provider: string, cfg?: QuantClawConfig): boolean {
...
function resolveAllowedFallbacks(params: { cfg: QuantClawConfig; agentId?: string }): string[] {
  if (params.agentId) {
...
export function buildConfiguredModelCatalog(params: { cfg: QuantClawConfig }): ModelCatalogEntry[] {
