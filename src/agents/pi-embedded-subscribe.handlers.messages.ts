...
function isTranscriptOnlyQuantClawAssistantMessage(message: AgentMessage | undefined): boolean {
...
export function handleMessageStart(
  ...
  if (msg?.role !== "assistant" || isTranscriptOnlyQuantClawAssistantMessage(msg)) {
    return;
  }
