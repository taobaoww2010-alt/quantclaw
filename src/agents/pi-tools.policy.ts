...
export function resolveSubagentToolPolicy(cfg?: QuantClawConfig, depth?: number): SandboxToolPolicy {
...
function resolveExplicitProfileAlsoAllow(tools?: QuantClawConfig["tools"]): string[] | undefined {
...
function resolveImplicitProfileAlsoAllow(params: {
  globalTools?: QuantClawConfig["tools"];
