...
function resolveAdaptiveReadMaxBytes(options?: QuantClawReadToolOptions): number {
...
export function createSandboxedReadTool(params: SandboxToolParams) {
  ...
  return createQuantClawReadTool(base, {
...
export function createQuantClawReadTool(
  base: AnyAgentTool,
  options?: QuantClawReadToolOptions,
): AnyAgentTool {
