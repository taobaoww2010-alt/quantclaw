...
export const DEFAULT_SANDBOX_IMAGE = "quantclaw-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "quantclaw-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "quantclaw-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "quantclaw-sandbox-common:bookworm-slim";
export const SANDBOX_BROWSER_SECURITY_HASH_EPOCH = "2026-02-28-no-sandbox-env";

export const DEFAULT_SANDBOX_BROWSER_PREFIX = "quantclaw-sbx-browser-";
export const DEFAULT_SANDBOX_BROWSER_NETWORK = "quantclaw-sandbox-browser";
