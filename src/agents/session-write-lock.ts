...
const CLEANUP_STATE_KEY = Symbol.for("quantclaw.sessionWriteLockCleanupState");
const HELD_LOCKS_KEY = Symbol.for("quantclaw.sessionWriteLockHeldLocks");
const WATCHDOG_STATE_KEY = Symbol.for("quantclaw.sessionWriteLockWatchdogState");
