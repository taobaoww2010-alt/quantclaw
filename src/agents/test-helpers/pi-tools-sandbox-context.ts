...
export function createPiToolsSandboxContext(params: PiToolsSandboxContextParams): SandboxContext {
  ...
  return {
    ...
    runtimeId: params.containerName ?? "quantclaw-sbx-test",
    runtimeLabel: params.containerName ?? "quantclaw-sbx-test",
    containerName: params.containerName ?? "quantclaw-sbx-test",
