...
export function resolveSessionToolsVisibility(cfg: QuantClawConfig): SessionToolsVisibility {
...
export function resolveSandboxSessionToolsVisibility(cfg: QuantClawConfig): "spawned" | "all" {
...
export function createAgentToAgentPolicy(cfg: QuantClawConfig): AgentToAgentPolicy {
