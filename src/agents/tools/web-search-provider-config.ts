...
type ConfiguredWebSearchProvider = NonNullable<
  NonNullable<NonNullable<QuantClawConfig["tools"]>["web"]>["search"]
>["provider"];

export type WebSearchConfig = NonNullable<QuantClawConfig["tools"]>["web"] extends infer Web
...
export function resolveSearchConfig(cfg?: QuantClawConfig): WebSearchConfig {
