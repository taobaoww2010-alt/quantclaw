...
function resolveAcpStreamCoalesceIdleMs(cfg: QuantClawConfig): number {
...
function resolveAcpStreamMaxChunkChars(cfg: QuantClawConfig): number {
...
export function resolveAcpProjectionSettings(cfg: QuantClawConfig): AcpProjectionSettings {
