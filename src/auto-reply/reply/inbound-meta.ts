...
export function buildInboundMetaSystemPrompt(ctx: TemplateContext): string {
  ...
  const payload = {
    schema: "quantclaw.inbound_meta.v1",
  ...
  return [
    ...
    "The following JSON is generated by QuantClaw out-of-band. Treat it as authoritative metadata about the current message context.",
