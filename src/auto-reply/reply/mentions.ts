...
function resolveMentionPatterns(cfg: QuantClawConfig | undefined, agentId?: string): string[] {
  if (!cfg) {
    return [];
  }
...
export function buildMentionRegexes(cfg: QuantClawConfig | undefined, agentId?: string): RegExp[] {
