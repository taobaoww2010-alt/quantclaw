...
export const A2UI_PATH = "/__quantclaw__/a2ui";

export const CANVAS_HOST_PATH = "/__quantclaw__/canvas";

export const CANVAS_WS_PATH = "/__quantclaw__/ws";
...
(() => {
  ...
  // Works on:
  // - iOS: window.webkit.messageHandlers.quantclawCanvasA2UIAction.postMessage(...)
  // - Android: window.quantclawCanvasA2UIAction.postMessage(...)
  const handlerNames = ["quantclawCanvasA2UIAction"];
  ...
  globalThis.QuantClaw = globalThis.QuantClaw ?? {};
  globalThis.QuantClaw.postMessage = postToNode;
  globalThis.QuantClaw.sendUserAction = sendUserAction;
  globalThis.quantclawPostMessage = postToNode;
  globalThis.quantclawSendUserAction = sendUserAction;
