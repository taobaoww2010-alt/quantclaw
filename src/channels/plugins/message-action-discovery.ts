...
export function listChannelMessageActions(cfg: QuantClawConfig): ChannelMessageActionName[] {
...
export function listChannelMessageCapabilities(cfg: QuantClawConfig): ChannelMessageCapability[] {
