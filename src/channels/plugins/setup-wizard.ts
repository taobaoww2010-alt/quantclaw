...
export type ChannelSetupWizardEnvShortcut = {
  ...
  isAvailable: (params: { cfg: QuantClawConfig; accountId: string }) => boolean;
  apply: (params: {
    cfg: QuantClawConfig;
    accountId: string;
...
export type ChannelSetupWizardCredential = {
  ...
  keepPrompt: string;
  inputPrompt: string;
  allowEnv?: (params: { cfg: QuantClawConfig; accountId: string }) => boolean;
  inspect: (params: {
    cfg: QuantClawConfig;
    accountId: string;
...
export type ChannelSetupWizardGroupAccess = {
  ...
  currentPolicy: (params: { cfg: QuantClawConfig; accountId: string }) => ChannelAccessPolicy;
  currentEntries: (params: { cfg: QuantClawConfig; accountId: string }) => string[];
  updatePrompt: (params: { cfg: QuantClawConfig; accountId: string }) => boolean;
  setPolicy: (params: {
    cfg: QuantClawConfig;
    accountId: string;
...
export type ChannelSetupWizard = {
  ...
  disable?: (cfg: QuantClawConfig) => QuantClawConfig;
