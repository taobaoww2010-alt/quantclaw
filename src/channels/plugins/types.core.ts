...
export type ChannelAgentToolFactory = (params: { cfg?: QuantClawConfig }) => ChannelAgentTool[];
...
export type ChannelAgentPromptAdapter = {
  messageToolHints?: (params: { cfg: QuantClawConfig; accountId?: string | null }) => string[];
