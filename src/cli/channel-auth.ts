...
function isConfiguredAuthPlugin(plugin: ChannelPlugin, cfg: QuantClawConfig): boolean {
  const key = plugin.id;
...
function resolveConfiguredAuthChannelInput(cfg: QuantClawConfig, mode: ChannelAuthMode): string {
