    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["quantclaw channels list", "List configured channels and auth profiles."],
          ["quantclaw channels status --probe", "Run channel status checks and probes."],
          [
            "quantclaw channels add --channel telegram --token <token>",
            "Add or update a channel account non-interactively.",
          ],
          ["quantclaw channels login --channel whatsapp", "Link a WhatsApp Web account."],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/channels",
          "docs.quantclaw.ai/cli/channels",
        )}\n`,
    );
