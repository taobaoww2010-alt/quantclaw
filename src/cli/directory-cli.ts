    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["quantclaw directory self --channel slack", "Show the connected account identity."],
          [
            'quantclaw directory peers list --channel slack --query "alice"',
            "Search contact/user IDs by name.",
          ],
          ["quantclaw directory groups list --channel discord", "List available groups/channels."],
          [
            "quantclaw directory groups members --channel discord --group-id <id>",
            "List members for a specific group.",
          ],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/directory",
          "docs.quantclaw.ai/cli/directory",
        )}\n`,
    )
    .action(() => {
