      ...
      .addHelpText(
        ...
        () =>
          `\n${theme.heading("Examples:")}\n${formatHelpExamples([
            ["quantclaw gateway run", "Run the gateway in the foreground."],
            ["quantclaw gateway status", "Show service status and probe reachability."],
            ["quantclaw gateway discover", "Find local and wide-area gateway beacons."],
            ["quantclaw gateway call health", "Call a gateway RPC method directly."],
          ])}\n\n${theme.muted("Docs:")} ${formatDocsLink("/cli/gateway", "docs.quantclaw.ai/cli/gateway")}\n`,
      ),
  );
