...
const SANDBOX_EXAMPLES = {
  main: [
    ["quantclaw sandbox list", "List all sandbox containers."],
    ["quantclaw sandbox list --browser", "List only browser containers."],
    ["quantclaw sandbox recreate --all", "Recreate all containers."],
    ["quantclaw sandbox recreate --session main", "Recreate a specific session."],
    ["quantclaw sandbox recreate --agent mybot", "Recreate agent containers."],
    ["quantclaw sandbox explain", "Explain effective sandbox config."],
  ],
  list: [
    ["quantclaw sandbox list", "List all sandbox containers."],
    ["quantclaw sandbox list --browser", "List only browser containers."],
    ["quantclaw sandbox list --json", "JSON output."],
  ],
  recreate: [
    ["quantclaw sandbox recreate --all", "Recreate all containers."],
    ["quantclaw sandbox recreate --session main", "Recreate a specific session."],
    [
      "quantclaw sandbox recreate --agent mybot",
      "Recreate a specific agent (includes sub-agents).",
    ],
    ["quantclaw sandbox recreate --browser --all", "Recreate only browser containers."],
    ["quantclaw sandbox recreate --all --force", "Skip confirmation."],
  ],
  explain: [
    ["quantclaw sandbox explain", "Show effective sandbox config."],
    ["quantclaw sandbox explain --session agent:main:main", "Explain a specific session."],
    ["quantclaw sandbox explain --agent work", "Explain an agent sandbox."],
    ["quantclaw sandbox explain --json", "JSON output."],
  ],
} as const;
...
export function registerSandboxCli(program: Command) {
  const sandbox = program
    ...
    .addHelpText(
      "after",
      () =>
        `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/sandbox", "docs.quantclaw.ai/cli/sandbox")}\n`,
    )
    .action(() => {
