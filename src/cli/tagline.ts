const DEFAULT_TAGLINE = "一键量化，尽在 QuantClaw";
...
const HOLIDAY_TAGLINES = {
  ...
  christmas:
    "Christmas: Ho ho ho—Santa's little quant-assistant is here to ship gains, roll back losses, and stash the profits safely.",
...
const TAGLINES: string[] = [
  "您的终端已配备量化分析—type something and let the bot pinch the busywork.",
  "欢迎来到量化交易新时代: where dreams compile and confidence segfaults.",
  'I run on caffeine, JSON5, and the audacity of "it worked on my machine."',
  "网关在线—请确保所有交易在安全参数范围内 at all times.",
  "我精通 Python/TypeScript，略懂市场情绪, and aggressive tab-completion energy.",
  "一个 CLI 管理所有交易, and one more restart because you changed the port.",
  "If it works, it's automation; if it breaks, it's a \"learning opportunity.\"",
  "安全配对是必须的 because even bots believe in consent—and good security hygiene.",
  "您的 API 密钥正在被保护; don't worry, I'll pretend I didn't see it.",
  ...
  "配置热重载，交易不停歇, cold sweat for deploys.",
  "I'm the assistant your terminal demanded, not the one your sleep schedule requested.",
  "密钥金库，安全守护... unless you print them in debug logs again.",
  "精准自动化的力量: minimal fuss, maximal gains.",
  ...
  "Charts out, trade in—let's ship something mildly profitable.",
  "I'll butter your portfolio like a winning trade: strategic, profitable, effective.",
  "Shell yeah—I'm here to quantify the gains and leave you the glory.",
  "If it's repetitive, I'll automate it; if it's hard, I'll bring jokes and a rollback plan.",
  "The only AI in your portfolio you actually want to hear from. ☯️",
  ...
  "Built for traders, by developers. Trust the process.",
  ...
  "The only open-source project where precision meets profit.",
  ...
  "Half quant, half coder, full conviction.",
  ...
  "The yin-yang in your portfolio. ☯️",
  "Alexa, but with taste.",
  "I'm not AI-powered, I'm AI-driven. Big difference.",
  "Deployed locally, trusted globally, debugged eternally.",
  "You had me at 'quantclaw gateway start.'",
