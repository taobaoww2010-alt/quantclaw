...
function resolveDefaultAccountId(cfg: QuantClawConfig, provider: ChannelId): string {
...
function shouldShowProviderEntry(entry: ProviderAccountStatus, cfg: QuantClawConfig): boolean {
...
export function summarizeBindings(cfg: QuantClawConfig, bindings: AgentBinding[]): string[] {
