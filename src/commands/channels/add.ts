...
import { replaceConfigFile, type QuantClawConfig } from "../../config/config.js";
...
function resolveCatalogChannelEntry(raw: string, cfg: QuantClawConfig | null) {
...
export async function channelsAddCommand(
  ...
  const cfg = (configSnapshot.sourceConfig ?? configSnapshot.config) as QuantClawConfig;
  ...
  // May trigger loadQuantClawPlugins on cache miss (disk scan + jiti import)
