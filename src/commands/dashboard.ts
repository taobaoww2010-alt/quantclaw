...
export async function dashboardCommand(
  ...
  if (resolvedToken.unresolvedRefReason) {
    ...
    runtime.log(
      "Set QUANTCLAW_GATEWAY_TOKEN in this shell or resolve your secret provider, then rerun `quantclaw dashboard`.",
    );
  }
  ...
  if (opened) {
    runtime.log("Opened in your browser. Keep that tab to control QuantClaw.");
  } else if (hint) {
    runtime.log(hint);
  }
}
