...
export function collectMissingDefaultAccountBindingWarnings(cfg: QuantClawConfig): string[] {
...
export function collectMissingExplicitDefaultAccountWarnings(cfg: QuantClawConfig): string[] {
  const warnings: string[] = [];
