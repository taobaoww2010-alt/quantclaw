...
export function scanLegacyToolsBySenderKeys(cfg: QuantClawConfig): LegacyToolsBySenderKeyHit[] {
...
export function maybeRepairLegacyToolsBySenderKeys(cfg: QuantClawConfig): {
