...
export async function setupInternalHooks(
  ...
  await prompter.note(
    [
      ...
      "",
      "Learn more: https://docs.quantclaw.ai/automation/hooks",
    ].join("\n"),
    "Hooks",
  );
  ...
  await prompter.note(
    [
      ...
      `  ${formatCliCommand("quantclaw hooks list")}`,
      `  ${formatCliCommand("quantclaw hooks enable <name>")}`,
      `  ${formatCliCommand("quantclaw hooks disable <name>")}`,
    ].join("\n"),
    "Hooks Configured",
  );
