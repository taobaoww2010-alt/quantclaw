...
function resolveAnthropicDefaultAuthMode(cfg: QuantClawConfig): AnthropicAuthDefaultsMode | null {
...
export function applyMessageDefaults(cfg: QuantClawConfig): QuantClawConfig {
...
export function applyTalkApiKey(config: QuantClawConfig): QuantClawConfig {
...
export function applyTalkConfigNormalization(config: QuantClawConfig): QuantClawConfig {
  return normalizeTalkConfig(config);
}

export function applyModelDefaults(cfg: QuantClawConfig): QuantClawConfig {
  let mutated = false;
  let nextCfg = cfg;
...
export function applyAgentDefaults(cfg: QuantClawConfig): QuantClawConfig {
...
export function applyLoggingDefaults(cfg: QuantClawConfig): QuantClawConfig {
...
export function applyContextPruningDefaults(cfg: QuantClawConfig): QuantClawConfig {
...
export function applyCompactionDefaults(cfg: QuantClawConfig): QuantClawConfig {
  const defaults = cfg.agents?.defaults;
  if (!defaults) {
    return cfg;
  }
