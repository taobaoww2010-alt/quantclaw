...
if (shouldWarnExtensionApiImport) {
  process.emitWarning(
    "quantclaw/extension-api is deprecated. Migrate to api.runtime.agent.* or focused openclaw/plugin-sdk/<subpath> imports. See https://docs.quantclaw.ai/plugins/sdk-migration",
    {
      ...
      detail:
        "This compatibility bridge is temporary. Bundled plugins should use the injected plugin runtime instead of importing host-side agent helpers directly. Migration guide: https://docs.quantclaw.ai/plugins/sdk-migration",
    },
  );
}
