...
export function hasAmbiguousGatewayAuthModeConfig(cfg: QuantClawConfig): boolean {
...
export function assertExplicitGatewayAuthModeWhenBothConfigured(cfg: QuantClawConfig): void {
