...
export function resolveGatewayReloadSettings(cfg: QuantClawConfig): GatewayReloadSettings {
...
export function startGatewayConfigReloader(opts: {
  initialConfig: QuantClawConfig;
  readSnapshot: () => Promise<ConfigFileSnapshot>;
  onHotReload: (plan: GatewayReloadPlan, nextConfig: QuantClawConfig) => Promise<void>;
  onRestart: (plan: GatewayReloadPlan, nextConfig: QuantClawConfig) => void | Promise<void>;
  ...
  let pendingInProcessConfig: QuantClawConfig | null = null;
  ...
  const queueRestart = (plan: GatewayReloadPlan, nextConfig: QuantClawConfig) => {
    if (restartQueued) {
      return;
    }
    restartQueued = true;
  ...
  const applySnapshot = async (nextConfig: QuantClawConfig) => {
