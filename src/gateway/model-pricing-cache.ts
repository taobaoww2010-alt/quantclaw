...
export function collectConfiguredModelPricingRefs(config: QuantClawConfig): ModelRef[] {
...
function scheduleRefresh(params: { config: QuantClawConfig; fetchImpl: typeof fetch }): void {
  clearRefreshTimer();
