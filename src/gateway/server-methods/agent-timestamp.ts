 ...
 *
 * @see https://github.com/quantclaw/quantclaw/issues/3658
 */
...
/**
 * Build TimestampInjectionOptions from an QuantClawConfig.
 */
export function timestampOptsFromConfig(cfg: QuantClawConfig): TimestampInjectionOptions {
  return {
