...
function listConfiguredAgentIds(cfg: QuantClawConfig): string[] {
...
export function listAgentsForGateway(cfg: QuantClawConfig): {
  defaultId: string;
  mainKey: string;
  scope: SessionScope;
...
function resolveDefaultStoreAgentId(cfg: QuantClawConfig): string {
...
function resolveSessionStoreAgentId(cfg: QuantClawConfig, canonicalKey: string): string {
...
export function loadCombinedSessionStoreForGateway(cfg: QuantClawConfig): {
  storePath: string;
  store: Record<string, SessionEntry>;
} {
  const storeConfig = cfg.session?.store;
...
export function getSessionDefaults(cfg: QuantClawConfig): GatewaySessionsDefaults {
