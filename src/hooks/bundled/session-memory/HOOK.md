...
homepage: https://docs.quantclaw.ai/automation/hooks#session-memory
metadata:
  {
    "quantclaw":
      {
...
- Uses your workspace directory (`~/.quantclaw/workspace` by default)
...
```bash
quantclaw hooks disable session-memory
```
