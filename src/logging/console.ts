...
type ConsoleConfigLoader = () => QuantClawConfig["logging"] | undefined;
...
function normalizeConsoleLevel(level?: string): LogLevel {
  ...
  if (!level && process.env.VITEST === "true" && process.env.QUANTCLAW_TEST_CONSOLE !== "1") {
    return "silent";
  }
...
function resolveConsoleSettings(): ConsoleSettings {
  ...
  if (
    ...
    process.env.QUANTCLAW_TEST_CONSOLE !== "1" &&
    !isVerbose() &&
    !envLevel &&
