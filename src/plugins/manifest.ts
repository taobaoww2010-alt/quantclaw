...
export const PLUGIN_MANIFEST_FILENAME = "quantclaw.plugin.json";
...
// package.json "quantclaw" metadata (used for setup/catalog)
...
export type QuantClawPackageStartup = {
  /**
...
export type QuantClawPackageManifest = {
  extensions?: string[];
  setupEntry?: string;
  channel?: PluginPackageChannel;
  install?: PluginPackageInstall;
  startup?: QuantClawPackageStartup;
};
...
): QuantClawPackageManifest | undefined {
  if (!manifest) {
    return undefined;
  }
