...
export function applyOpenAIProviderConfig(cfg: QuantClawConfig): QuantClawConfig {
...
export function applyOpenAIConfig(cfg: QuantClawConfig): QuantClawConfig {
...
export function applyOpencodeGoModelDefault(cfg: QuantClawConfig): {
  next: QuantClawConfig;
  changed: boolean;
} {
...
export function applyOpencodeZenModelDefault(cfg: QuantClawConfig): {
  next: QuantClawConfig;
  changed: boolean;
} {
