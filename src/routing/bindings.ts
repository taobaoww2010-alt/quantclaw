...
export function listBindings(cfg: QuantClawConfig): AgentRouteBinding[] {
...
export function listBoundAccountIds(cfg: QuantClawConfig, channelId: string): string[] {
...
export function buildChannelAccountBindings(cfg: QuantClawConfig) {
