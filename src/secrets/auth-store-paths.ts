...
export function listAuthProfileStorePaths(config: QuantClawConfig, stateDir: string): string[] {
...
export function collectAuthStorePaths(config: QuantClawConfig, stateDir: string): string[] {
