...
function resolveResolutionLimits(config: QuantClawConfig): ResolutionLimits {
...
function resolveConfiguredProvider(ref: SecretRef, config: QuantClawConfig): SecretProviderConfig {
