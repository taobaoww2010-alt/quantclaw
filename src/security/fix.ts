...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof QuantClawConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: QuantClawConfig; env: NodeJS.ProcessEnv }): {
  cfg: QuantClawConfig;
  changes: string[];
  policyFlips: Set<string>;
} {
