    ...
    <div class="login-gate">
      <div class="login-gate__card">
        <div class="login-gate__header">
          <img class="login-gate__logo" src=${faviconSrc} alt="QuantClaw" />
          <div class="login-gate__title">QuantClaw</div>
        ...
        <div class="login-gate__help">
          ...
          <ol class="login-gate__steps">
            <li>
              ${t("overview.connection.step1")}${renderConnectCommand("quantclaw gateway run")}
            </li>
            <li>${t("overview.connection.step2")} ${renderConnectCommand("quantclaw dashboard")}</li>
